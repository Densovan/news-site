    ...
    like: {
      ...
      resolve: async (parent, args, context) => {
        try {
          ...
          const existingLike = await LikeModel.findOne({ userId: context.id, postId: args.postId});
          ...
          if (context.id === existingLike.userId && args.postId === existingLike.postId) {
            console.log("userId", context.id);
            await LikeModel.findOneAndDelete({ userId: context.id, postId: args.postId });
