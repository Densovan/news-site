  ...
  return (
    <React.Fragment>
      <Card className="card-article">
        ...
        <div>
          <Typography.Title level={5} style={{ fontSize:12, color: '#262e3c', fontWeight: 'bold' }}>CATEGORY</Typography.Title>
        </div>
        ...
        <div>
          <Typography.Title level={5} style={{ fontSize:12, color: '#262e3c', fontWeight: 'bold'}}>TYPE</Typography.Title>
        </div>
        <div style={{ marginTop: 12}}>
        {typeData.map(types => (
          <CheckableTag
      ...
      <Card className="card-article">
        ...
        <Row justify="space-between" align="middle">
          <Col style={{ display: 'flex' }} span={18}>
            ...
            <div>
              <div style={{ fontSize:16, color: '#262e3c', fontWeight: 'bold' }}>Vann Soklay</div>
              {/* {res.title.length <= 70
                          ? res.title
                          : res.title.substring(0, 70) + " ..."} */}
              <div style={{ fontSize:12, color: 'rgba(117, 117, 117, 1)', fontWeight: '400' }}>Staff writer, The New Yorker</div>
            </div>
          </Col>
          <Col span={6}>
            <Button type="primary" style={{ borderRadius: '40px', fontSize:14 }}>Follow</Button>
          </Col>
        </Row>
      </Card>
    </React.Fragment>
