...
import { GET_NEWS_SEARCH, GET_USER, GET_VOTE_UP_DOWN, GET_ALL_VOTE_UP_DOWN } from "../graphql/query";
...
const search = () => {
  ...
  if (loading || !data || userLoading || vote_up_down_loading || loading_all_vote) {
    return (
